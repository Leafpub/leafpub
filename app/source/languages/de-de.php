...
return [
    ...
    'cache_has_been_cleared' => 'Cache wurde geleert',
    'cache_templates_for_faster_rendering' => 'Cache Templatedateien für schnelleres Rendering (empfohlen)',
    'cache' => 'Cache',
    'cancel' => 'Abbrechen',
    ...
    'custom_code' => 'Eigener Code',	// custom
    ...
    'feed' => 'Feed',
    'file_uploaded_successfully' => 'Datei erfolgreich bearbeitet',
    'file_deleted_successfully' => 'Datei erfolgreich gelöscht',
    'full_name' => 'Name',
    'general' => 'Generell',
    'generator_enabled' => 'Zeig etwas Anerkennung und füge den generator meta tag zu head hinzu',
    ...
    'homepage' => 'Homepage',
    'html' => 'HTML',
    'if_this_was_sent_in_error_you_can_ignore_this_message' => 'Falls dies fälschlicherweise gesendet wurde, kann diese Nachricht ignoriert werden.',
    'image' => 'Bild',
    'import' => 'Import',
    'import_flush_tables' => 'Tabellen leeren (Alle Daten werden gelöscht)',
    'import_import_user' => 'Import user',
    'import_local_media' => 'Importiere Medien von lokalem server',
    'import_no_media' => 'Medien nicht importieren',
    'import_remote_media' => 'Importiere Medien von entferntem server',
    'import_use_category_as_tag' => 'Nutze Kategorien als Tags',
    'import_welcome' => 'Willkommen beim Leafpub importer',
    'increase_indent' => 'Einrückung vergrößern',
    'initial_version' => 'Ausgangsversion',
    'inject_this_code_into_leafpub_foot' => 'Diesen Code in {{leafpub_foot}} injizieren',
    'inject_this_code_into_leafpub_head' => 'Diesen Code in {{leafpub_head}} injizieren',
    ...
    'show_this_message_in_maintenance_mode' => 'Zeige diese Mitteilung im Wartungsmodus',
    'meta_description' => 'Metabeschreibung',
    'meta_title' => 'Metatitel',
    'metadata' => 'Metadaten',
    'min_read' => 'min zu lesen',
    ...
    'plugins' => 'Plugins',
    'post' => 'Post',
    'leafpub_can_create_a_backup_of_your_entire_website...' => 'Leafpub kann eine Sicherung der gesamten Webseite erstellen. Sicherungen werden auf dem Server gespeichert, aber sollten auch an einen sicheren Ort auf dem Computer heruntergeladen werden.',
    ...
    'search' => 'Suche',
    'select' => 'Auswählen',
    'select_a_xml_file_to_import' => 'Datei auswählen',
    'select_blog_plattform' => 'Wähle eine Blog Plattform',
    'set_post_image' => 'Postbild setzen',
    'settings' => 'Einstellungen',
    'share_a_sentence_or_two_about_yourself' => 'Schreiben Sie ein bis zwei Sätze über sich',	// "Sie" ist verbreiteter und üblich in Deutschland. Du sagt man zu Freunden und Bekannten.
    'slug' => 'Rohling',
    'source' => 'Quelle',
    'status' => 'Status',
    'sticky' => 'Sticky',
    ...
    'the_owner_role_cannot_be_revoked_or_reassigned' => 'Die Besitzerrolle kann nicht entzogen oder neu zugeordnet werden',
