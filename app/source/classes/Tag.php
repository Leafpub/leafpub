...
class Tag extends Postleaf {
    ...
    public static function delete($slug) {
        ...
        Postleaf::dispatchEvent('tag.delete', $event_data);
        ...
        // Dispatch tag.deleted
        $event_data = [
            'slug' => $slug
        ];
        Postleaf::dispatchEvent('tag.deleted', $event_data);
    ...
    public static function get($slug) {
        // Dispatch tag.retrieve
        $event_data = [
            'slug' => $slug
        ];
        Postleaf::dispatchEvent('tag.retrieve', $event_data);
        ...
        // Dispatch tag.retrieved
        $event_data = [
            'tag' => $tag
        ];
        Postleaf::dispatchEvent('tag.retrieved', $event_data);
    ...
    public static function getMany($options = null, &$pagination = null) {
        // Dispatch tags.retrieve
        $event_data = [
            'options' => $options
        ];
        Postleaf::dispatchEvent('tags.retrieve', $event_data);
        ...
        // Dispatch tags.retrieved
        $event_data = [
            'tags' => $tags
        ];
        Postleaf::dispatchEvent('tags.retrieved', $event_data);
    ...
    public static function render($slug, $page = 1) {
        ...
        if(!$tag) return false;
         ...
         // Dispatch tags.render
        $event_data = [
            'slug' => $slug,
        ];
        Postleaf::dispatchEvent('tags.render', $event_data);
        ...
        // Dispatch tags.rendered
        $event_data = [
            'slug' => $slug,
            'html' => $html
        ];
        Postleaf::dispatchEvent('tags.rendered', $event_data);
    ...
    public static function update($slug, $properties) {
        ...
        Postleaf::dispatchEvent('tag.update', $event_data);
